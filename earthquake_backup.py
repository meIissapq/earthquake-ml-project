...
step4_features = step4_features.fillna(0)
...
final_df[feature_col_final] = final_df[feature_col_final].fillna(0)
...
# 1. Load the ml_final_dataset.csv file
df = pd.read_csv("ml_final_dataset.csv", parse_dates=["month_date"])
